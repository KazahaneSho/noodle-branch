...
#include "NoodlingGameplayRpcRegistrationComponent.generated.h"

#define UE_API NOODLEBRANCH_API

/**
 * Test Component for External Http Rpc Registration.
 */
UCLASS(MinimalAPI)
class UNoodlingGameplayRpcRegistrationComponent : public UExternalRpcRegistrationComponent
{
	GENERATED_BODY()

protected:
	static UE_API UNoodlingGameplayRpcRegistrationComponent* ObjectInstance;

public:
	static UE_API UNoodlingGameplayRpcRegistrationComponent* GetInstance();
	...
	*/
	UE_API static TSharedPtr<FJsonObject> GetJsonObjectFromRequestBody(TArray<uint8> InRequestBody);
