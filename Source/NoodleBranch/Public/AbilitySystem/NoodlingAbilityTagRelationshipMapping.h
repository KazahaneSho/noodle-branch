...
#include "NoodlingAbilityTagRelationshipMapping.generated.h"

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FNoodlingAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UNoodlingAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FNoodlingAbilityTagRelationship> AbilityTagRelationships;
};
